...
const CulturePage = () => {
    ...
    const cultureData = [
        ...
        },
        {
            ...
            list: [
                <span><strong>Fli</strong>  -  Jelo napravljeno od tankih slojeva testa premazanih kajmakom ili jogurtom, koje se peče na otvorenom ognjištu.</span>,
        ...
        },
        {
            ...
            list: [
                <span><strong>Bajram</strong>  -  Praznik koji označava kraj Ramazana, meseca posta. Tokom Bajrama, porodice se okupljaju, mole i priređuju bogate obroke.</span>,
        ...
        },
        {
            ...
            list: [
                ...
                <span><strong>Rođenja</strong>  -  Rođenje deteta se slavi sa velikom radošću, često uz posebne obrede i darivanje.</span>
            ],
            photo: wedding
        },
        {
            ...
            list: [
                <span><strong>Dan nezavisnosti Albanije (28. novembar)</strong>  -  Praznik koji se proslavlja uz patriotske pesme, plesove i ceremonije.</span>,
